...
describe('Tasks',()=>{
    ...
    describe('Create Task Route',()=>{
        it('it should allow an authenticated user to create a simple task',(done)=>{
        ...
        it('it should allow an authenticated user to create a task with all options',(done)=>{
            const user = createGoodUserData();
            const newUser = new User(user);
            createUser(newUser);
            const token = userLogin(newUser);
        ...
        it('it should not allow an authenticated user to create a task without a name',(done)=>{
            const user = createGoodUserData();
            const newUser = new User(user);
            createUser(newUser);
            const token = userLogin(newUser);
        ...
        it('it should not allow an unauthenticated user to create a task',(done)=>{
            const user = createGoodUserData();
            const newUser = new User(user);
            createUser(newUser);
            const categories = createCategoriesData();
        ...
        it('it should not allow a user with an invalid token to create a task',(done)=>{
            const user = createGoodUserData();
            const newUser = new User(user);
            createUser(newUser);
            const token = userLogin(newUser);
    ...
    describe('Get Tasks Route',()=>{
        it('it should allow an authenticated user to retrieve all tasks',(done)=>{
            const user = createGoodUserData();
            const newUser = new User(user);
            createUser(newUser);
            const token = userLogin(newUser);
        ...
        it('it should not allow a user with invalid token to retrieve all tasks',(done)=>{
            const user = createGoodUserData();
            const newUser = new User(user);
            createUser(newUser);
            const token = userLogin(newUser);
        ...
        it('it should not allow an unauthenticated user to retrieve all tasks',(done)=>{
            const user = createGoodUserData();
            const newUser = new User(user);
            createUser(newUser);
            const task1 = createSimpleTask();
    ...
    describe('Get Single Task Route',()=>{
        it('it should allow an authenticated user to retrieve a single task',(done)=>{
            const user = createGoodUserData();
            const newUser = new User(user);
            createUser(newUser);
            const token = userLogin(newUser);
        ...
        it('it should not allow an authenticated user to retrieve a single task which does not exist',(done)=>{
            const user = createGoodUserData();
            const newUser = new User(user);
            createUser(newUser);
            const token = userLogin(newUser);
        ...
        it('it should not allow an unauthenticated user to retrieve a single task',(done)=>{
            const user = createGoodUserData();
            const newUser = new User(user);
            createUser(newUser);
            const task = createSimpleTask();
        ...
        it('it should not allow a user with an invalid token to retrieve a single task',(done)=>{
            const user = createGoodUserData();
            const newUser = new User(user);
            createUser(newUser);
            const token = userLogin(newUser);
    ...
    describe('Get Tasks By Status',()=>{
        it('it should allow an authenticated user to retrieve all tasks by status',(done)=>{
            const user = createGoodUserData();
            const newUser = new User(user);
            createUser(newUser);
            const token = userLogin(newUser);
        ...
        it('it should not allow an unauthenticated user to retrieve all tasks by status',(done)=>{
            const user = createGoodUserData();
            const newUser = new User(user);
            createUser(newUser);
            const task1 = createSimpleTask();
        ...
        it('it should allow a user with an invalid token to retrieve all tasks',(done)=>{
            const user = createGoodUserData();
            const newUser = new User(user);
            createUser(newUser);
            const token = userLogin(newUser);
    ...
    describe('Get Tasks By Priority',()=>{
        it('it should allow an authenticated user to retrieve all tasks by priority',(done)=>{
            const user = createGoodUserData();
            const newUser = new User(user);
            createUser(newUser);
            const token = userLogin(newUser);
        ...
        it('it should not allow an unauthenticated user to retrieve all tasks by priority',(done)=>{
            const user = createGoodUserData();
            const newUser = new User(user);
            createUser(newUser);
            const task1 = createSimpleTask();
    ...
    describe('Get Tasks By Date',()=>{
        it('it should allow an authenticated user to retrieve all tasks by start date',(done)=>{
            const user = createGoodUserData();
            const newUser = new User(user);
            createUser(newUser);
            const token = userLogin(newUser);
        ...
        it('it should allow an authenticated user to retrieve all tasks by end date',(done)=>{
            const user = createGoodUserData();
            const newUser = new User(user);
            createUser(newUser);
            const token = userLogin(newUser);
        ...
        it('it should not allow a user with an invalid token to retrieve all tasks by date',(done)=>{
            const user = createGoodUserData();
            const newUser = new User(user);
            createUser(newUser);
            const token = userLogin(newUser);
        ...
        it('it should not allow an unauthenticated user to retrieve all tasks by date',(done)=>{
            const user = createGoodUserData();
            const newUser = new User(user);
            createUser(newUser);
            const task1 = createTaskData([]);
    ...
    describe('Get Tasks By Category',()=>{
        it('it should allow an authenticated user to retrieve tasks by category',(done)=>{
            const user = createGoodUserData();
            const newUser = new User(user);
            createUser(newUser);
            const token = userLogin(newUser);
        ...
        it('it should not allow a user with an invalidToken to retrieve tasks by category',(done)=>{
            const user = createGoodUserData();
            const newUser = new User(user);
            createUser(newUser);
            const token = userLogin(newUser);
        ...
        it('it should not allow an unauthenticated user to retrieve tasks by category',(done)=>{
            const user = createGoodUserData();
            const newUser = new User(user);
            createUser(newUser);
            const categories = createCategoriesData();
    ...
    describe('Update Task',()=>{
        it('it should allow an authenticated user to update a task',(done)=>{
            const user = createGoodUserData();
            const newUser = new User(user);
            createUser(newUser);
            const token = userLogin(newUser);
        ...
        it('it should not allow an authenticated user to update a task which does not exist',(done)=>{
            const user = createGoodUserData();
            const newUser = new User(user);
            createUser(newUser);
            const token = userLogin(newUser);
        ...
        it('it should not allow an unauthenticated user to update a task',(done)=>{
            const user = createGoodUserData();
            const newUser = new User(user);
            createUser(newUser);
            const categories = createCategoriesData();
        ...
        it('it should not allow a user with an invalid token to update a task',(done)=>{
            const user = createGoodUserData();
            const newUser = new User(user);
            createUser(newUser);
            const token = userLogin(newUser);
    ...
    describe('Delete Task Route',()=>{
        it('it should allow an authenticated user to delete a task',(done)=>{
            const user = createGoodUserData();
            const newUser = new User(user);
            createUser(newUser);
            const token = userLogin(newUser);
        ...
        it('it should not allow an unauthenticated user to delete a task',(done)=>{
            const user = createGoodUserData();
            const newUser = new User(user);
            createUser(newUser);
            const task = createSimpleTask();
        ...
        it('it should not allow a user with an invalid token to delete a task',(done)=>{
            const user = createGoodUserData();
            const newUser = new User(user);
            createUser(newUser);
            const token = userLogin(newUser);
