...
describe('SubTasks', function () {
  ...
  describe('Create SubTask', function () {
    it('it should allow an authenticated user to create a subtask of a task', function (done) {
    ...
    it('it should not allow an authenticated user to create a subtask of a task which does not exist', function (done) {
      const user = createGoodUserData()
      const newUser = new User(user)
      createUser(newUser)
      const token = userLogin(newUser)
    ...
    it('it should not allow an unauthenticated user to create a subtask of a task', function (done) {
      const user = createGoodUserData()
      const newUser = new User(user)
      createUser(newUser)
      const categories = createCategoriesData()
    ...
    it('it should not allow a user with an invalid token to create a subtask of a task', function (done) {
      const user = createGoodUserData()
      const newUser = new User(user)
      createUser(newUser)
      const token = userLogin(newUser)
  ...
  describe('Get SubTasks By Task Id', function () {
    it('it should allow an authenticated user to retrieve all subtasks of a given task', function (done) {
      const user = createGoodUserData()
      const newUser = new User(user)
      createUser(newUser)
      const token = userLogin(newUser)
    ...
    it('it should not allow an authenticated user to retrieve all subtasks of a given task which does not exist', function (done) {
      const user = createGoodUserData()
      const newUser = new User(user)
      createUser(newUser)
      const token = userLogin(newUser)
    ...
    it('it should not allow an unauthenticated user to retrieve all subtasks of a given task', function (done) {
      const user = createGoodUserData()
      const newUser = new User(user)
      createUser(newUser)
      const categories = createCategoriesData()
    ...
    it('it should not allow a user with an invalid token to retrieve all subtasks of a given task', function (done) {
      const user = createGoodUserData()
      const newUser = new User(user)
      createUser(newUser)
      const token = userLogin(newUser)
  ...
  describe('Update SubTask', function () {
    it('it should allow an authenticated user to update a subtask', function (done) {
      const user = createGoodUserData()
      const newUser = new User(user)
      createUser(newUser)
      const token = userLogin(newUser)
    ...
    it('it should not allow an authenticated user to update a subtask which does not exist', function (done) {
      const user = createGoodUserData()
      const newUser = new User(user)
      createUser(newUser)
      const token = userLogin(newUser)
    ...
    it('it should not allow an unauthenticated user to update a subtask', function (done) {
      const user = createGoodUserData()
      const newUser = new User(user)
      createUser(newUser)
      const categories = createCategoriesData()
    ...
    it('it should not allow a user with an invalid token to update a subtask', function (done) {
      const user = createGoodUserData()
      const newUser = new User(user)
      createUser(newUser)
      const token = userLogin(newUser)
  ...
  describe('Delete SubTask', function () {
    it('it should allow an authenticated user to delete a subtask', function (done) {
      const user = createGoodUserData()
      const newUser = new User(user)
      createUser(newUser)
      const token = userLogin(newUser)
    ...
    it('it should not allow an authenticated user to delete a subtask which does not exist', function (done) {
      const user = createGoodUserData()
      const newUser = new User(user)
      createUser(newUser)
      const token = userLogin(newUser)
    ...
    it('it should allow an unauthenticated user to delete a subtask', function (done) {
      const user = createGoodUserData()
      const newUser = new User(user)
      createUser(newUser)
      const categories = createCategoriesData()
    ...
    it('it should allow a user with an invalid token to delete a subtask', function (done) {
      const user = createGoodUserData()
      const newUser = new User(user)
      createUser(newUser)
      const token = userLogin(newUser)
