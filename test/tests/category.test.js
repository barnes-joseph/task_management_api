...
describe('Categories', function () {
  ...
  describe('Create Category Route', function () {
    it('it should allow an authenticated user to create a category', function (done) {
    ...
    it('it should not allow an authenticated user to create a category whose name exists', function (done) {
      const user = createGoodUserData()
      const newUser = new User(user)
      createUser(newUser)
      const category = createCategoryData()
    ...
    it('it should not allow an unauthenticated user to create a category', function (done) {
      const user = createGoodUserData()
      const newUser = new User(user)
      createUser(newUser)
      const category = createCategoryData()
    ...
    it('it should not allow a user with an invalid token to create a category', function (done) {
      const user = createGoodUserData()
      const newUser = new User(user)
      createUser(newUser)
      const category = createCategoryData()
    ...
    it('it should not allow a user with a token to create a category without a category name', function (done) {
      const user = createGoodUserData()
      const newUser = new User(user)
      createUser(newUser)
      const category = createCategoryData()
  ...
  describe('Get All Categories Route', function () {
    it('it should allow an authenticated user to get all categories', function (done) {
      const user = createGoodUserData()
      const newUser = new User(user)
      createUser(newUser)
      const token = userLogin(newUser)
    ...
    it('it should not allow an unauthenticated user to get all categories', function (done) {
      const user = createGoodUserData()
      const newUser = new User(user)
      createUser(newUser)
      const category1 = createCategoryData()
    ...
    it('it should not allow a user with an to get all categories', function (done) {
      const user = createGoodUserData()
      const newUser = new User(user)
      createUser(newUser)
      const category1 = createCategoryData()
  ...
  describe('Get Category By Name Route', function () {
    it('it should allow an authenticated user to get a category by name', function (done) {
      const user = createGoodUserData()
      const newUser = new User(user)
      createUser(newUser)
      const category = createCategoryData()
    ...
    it('it should not allow an authenticated user to get a category that does not exist', function (done) {
      const user = createGoodUserData()
      const newUser = new User(user)
      createUser(newUser)
      const category = createCategoryData()
    ...
    it('it should not allow an unauthenticated user to get a category', function (done) {
      const user = createGoodUserData()
      const newUser = new User(user)
      createUser(newUser)
      const category = createCategoryData()
    ...
    it('it should not allow a user with an invalid token to get a category', function (done) {
      const user = createGoodUserData()
      const newUser = new User(user)
      createUser(newUser)
      const category = createCategoryData()
  ...
  describe('Update Categories Route', function () {
    it('it should allow an authenticated user to update a category', function (done) {
      const user = createGoodUserData()
      const newUser = new User(user)
      createUser(newUser)
      const category = createCategoryData()
    ...
    it('it should not allow an authenticated user to update a category which does not exist', function (done) {
      const user = createGoodUserData()
      const newUser = new User(user)
      createUser(newUser)
      const category = createCategoryData()
    ...
    it('it should not allow an unauthenticated user to update a category', function (done) {
      const user = createGoodUserData()
      const newUser = new User(user)
      createUser(newUser)
      const category = createCategoryData()
    ...
    it('it should not allow a user with an invalid token to update a category', function (done) {
      const user = createGoodUserData()
      const newUser = new User(user)
      createUser(newUser)
      const category = createCategoryData()
  ...
  describe('Delete Categories Route', function () {
    it('it should allow an authenticated user to delete a category', function (done) {
      const user = createGoodUserData()
      const newUser = new User(user)
      createUser(newUser)
      const category = createCategoryData()
    ...
    it('it should not allow an authenticated user to delete a category which does not exist', function (done) {
      const user = createGoodUserData()
      const newUser = new User(user)
      createUser(newUser)
      const category = createCategoryData()
    ...
    it('it should not allow an unauthenticated user to delete a category', function (done) {
      const user = createGoodUserData()
      const newUser = new User(user)
      createUser(newUser)
      const category = createCategoryData()
    ...
    it('it should not allow a user with an invalid token to delete a category', function (done) {
      const user = createGoodUserData()
      const newUser = new User(user)
      createUser(newUser)
      const category = createCategoryData()
