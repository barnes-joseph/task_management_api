...
describe('Users', function () {
  ...
  // Test /user/login
  describe('Login User Router', function () {
    it('it should log a user with a valid email and password into the application', function (done) {
      const user = createGoodUserData()
      const newUser = new User(user)
      createUser(newUser)
      chai.request(app)
    ...
    it('it should log a user with a valid username and password into the application', function (done) {
      const user = createGoodUserData()
      const newUser = new User(user)
      createUser(newUser)
      chai.request(app)
    ...
    it('it should not log a user with an invalid email and password into the application', function (done) {
      const user = createGoodUserData()
      const newUser = new User(user)
      createUser(newUser)
      const random_email = createEmail()
    ...
    it('it should not log a user with an invalid username and password into the application', function (done) {
      const user = createGoodUserData()
      const newUser = new User(user)
      createUser(newUser)
      const random_username = createUsername()
    ...
    it('it should not log a user with an valid email and invalid password into the application', function (done) {
      const user = createGoodUserData()
      const newUser = new User(user)
      createUser(newUser)
    ...
    it('it should not log a user with an valid username and invalid password into the application', function (done) {
      const user = createGoodUserData()
      const newUser = new User(user)
      createUser(newUser)
      const random_password = createPassword()
  ...
  describe('Update User Route', function () {
    it('it should update a user with valid token and good data format', function (done) {
      const user = createGoodUserData()
    ...
    it('it should not update a user with valid token and bad data format', function (done) {
      const user = createGoodUserData()
      const newUsername = createUsername()
      const newEmail = createEmail()
      const newUser = new User(user)
    ...
    it('it should not update a user with valid token and email that already exists', function (done) {
    ...
    it('it should not update a user with valid token and username that already exists', function (done) {
      const user1 = createGoodUserData()
      const user2 = createRandomUser()
      const newEmail = createEmail()
      const newUser1 = new User(user1)
    ...
    it('it should not update a user without a token', function (done) {
      const user1 = createGoodUserData()
      const user2 = createRandomUser()
      const newEmail = createEmail()
      const newUser1 = new User(user1)
    ...
    it('it should not update a user with an invalid token', function (done) {
      const user1 = createGoodUserData()
      const newUsername = createUsername()
      const newEmail = createEmail()
      const newUser1 = new User(user1)
  ...
  describe('Change User Password Route', function () {
    it('it should allow an authenticated user to change a password with valid previous password and good data format', function (done) {
      const user = createGoodUserData()
      const newUser = new User(user)
    ...
    it('it should not allow an authenticated user to change a password with bad data format', function (done) {
      const user = createGoodUserData()
      const newUser = new User(user)
      const newPassword = createPassword()
      createUser(newUser)
    ...
    it('it should not allow an authenticated user to change a password with invalid previous password', function (done) {
      const user = createGoodUserData()
      const newUser = new User(user)
      const newPassword = createPassword()
    ...
    it('it should not allow a user without a token to change a password', function (done) {
      const user = createGoodUserData()
      const newUser = new User(user)
      const newPassword = createPassword()
      const randomPassword = createPassword()
    ...
    it('it should not allow a user with an invalid token to change a password', function (done) {
      const user = createGoodUserData()
      const newUser = new User(user)
      const newPassword = createPassword()
      const randomPassword = createPassword()
  ...
  describe('Change User Profile Picture Route', function () {
    it('it should allow an authenticated user to change his/her profile', function (done) {
      const user = createGoodUserData()
      const newUser = new User(user)
      createUser(newUser)
    ...
    it('it should not allow a user without a token to change his/her profile', function (done) {
      const user = createGoodUserData()
      const newUser = new User(user)
      createUser(newUser)
      const updatedUser = { ...newUser, profile: 'test/test-data/test-image.png' }
    ...
    it('it should not allow a user with an invalid token to change his/her profile', function (done) {
      const user = createGoodUserData()
      const newUser = new User(user)
      createUser(newUser)
      const token = userLogin(newUser)
  ...
  describe('Delete User Route', function () {
    it('it should an authenticated user to delete his/her account', function (done) {
      const user = createGoodUserData()
      const newUser = new User(user)
      createUser(newUser)
      const token = userLogin(newUser)
    ...
    it('it should not allow an unauthenticated user to delete his/her account', function (done) {
      const user = createGoodUserData()
      const newUser = new User(user)
      createUser(newUser)
      chai.request(app)
    ...
    it('it should not allow a user with an invalid to delete his/her account', function (done) {
      const user = createGoodUserData()
      const newUser = new User(user)
      createUser(newUser)
      const token = userLogin(newUser)
